...
setTimeout(() => {
  ...
  // ==================== Botão minimizar elegante sem "+" ====================
  let minimized = false;
  const toggleBtn = document.createElement("button");
  toggleBtn.id = "toggleBtn";
  toggleBtn.textContent = "";  // símbolo removido
  ...
  `;
  toggleBtn.onmouseover = () => { toggleBtn.style.background="#111"; };
  toggleBtn.onmouseleave = () => { toggleBtn.style.background="black"; };
...
}, 1700);    <div id="trk_header" style="cursor:move;font-weight:bold;margin-bottom:5px;text-align:center;font-size:16px;">Trakinas PC</div>
    <div style="display:flex; flex-direction:column; align-items:center; margin-bottom:5px;">
      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSUd-rV7R8ol927J-dJLHmhnxon9jeb1jV9Lw&s"
      style="width:60px;height:60px;border-radius:50%;border:2px solid #ff0;">
      <div style="font-size:10px;color:#ff0;margin-top:2px;">Criador: Trakinas</div>
...
}, 1700);  setTimeout(()=>{gui.style.opacity = "1";}, 50);
  ...
  toggleBtn.style.cssText = `
    ...
    transition: all 0.3s ease;
  `;
  toggleBtn.onmouseover = () => { toggleBtn.style.boxShadow = "0 0 15px #ff0"; toggleBtn.style.transform="scale(1.1)"; };
  toggleBtn.onmouseleave = () => { toggleBtn.style.boxShadow = "0 0 8px #ff0"; toggleBtn.style.transform="scale(1)"; };
  toggleBtn.onclick = ()=>{ minimized = !minimized; gui.style.display = minimized ? "none" : "block"; };
  document.body.appendChild(toggleBtn);
