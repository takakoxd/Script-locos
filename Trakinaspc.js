// ==================== Botão minimizar elegante e compacto ====================
...
toggleBtn.style.cssText = `
  ...
  border-radius:12px;
  background:black;   /* fundo escuro */
  color:#ff0;         /* cor do "+" */
  border:2px solid #ff0;  /* neon apenas na borda do botão */
  font-size:24px;
  font-weight:bold;
  cursor:pointer;
  z-index:1000000;
  display:flex; justify-content:center; align-items:center;  /* centraliza o "+" */
  transition: all 0.3s ease;
`;
toggleBtn.onmouseover = () => { toggleBtn.style.background="#111"; };  // leve efeito hover dentro do botão
